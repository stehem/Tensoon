ActionController::Routing::Routes.draw do |map|
  ...
  map.connect "/faq" , :controller => "tensoon" , :action => "faq"
  ...
  map.connect "/sessions/logout" , :controller => "sessions" , :action => "logout"
  map.connect "/stories/poster" , :controller => "stories" , :action => "poster"
  map.connect "/votes/vote" , :controller => "votes" , :action => "vote"
  map.connect "/comments/poster" , :controller => "comments" , :action => "poster"
